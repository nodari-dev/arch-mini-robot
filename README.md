...
Cute robot project made completelly from scratch with love to engineering and programming, using python for embedded development and creating custom CAD model for 3d printing.
